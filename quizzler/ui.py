...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        true_btn = Button(image=true_img, highlightthickness=0, command=self.true_pressed)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.true_pressed.config(state="disable")
            self.false_pressed.config(state="disable")
